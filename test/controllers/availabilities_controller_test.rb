...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference("Availability.count") do
      post availabilities_url, params: { availability: { available: @availability.available, available_for_id: @availability.available_for_id, available_for_type: @availability.available_for_type, available_on: @availability.available_on, end_time: @availability.end_time, start_time: @availability.start_time } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { available: @availability.available, available_for_id: @availability.available_for_id, available_for_type: @availability.available_for_type, available_on: @availability.available_on, end_time: @availability.end_time, start_time: @availability.start_time } }
