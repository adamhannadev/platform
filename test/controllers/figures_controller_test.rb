...
class FiguresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create figure" do
    assert_difference("Figure.count") do
      post figures_url, params: { figure: { bars: @figure.bars, components: @figure.components, core: @figure.core, dance: @figure.dance, name: @figure.name, number: @figure.number } }
    end
  ...
  test "should update figure" do
    patch figure_url(@figure), params: { figure: { bars: @figure.bars, components: @figure.components, core: @figure.core, dance: @figure.dance, name: @figure.name, number: @figure.number } }
